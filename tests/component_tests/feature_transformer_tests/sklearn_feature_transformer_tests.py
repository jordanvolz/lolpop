...
class TestsklearnFeatureTranformer:
    ...
    def _get_config(self, config): 
        config["conf"]["config"]["transformers"] = [
            {"transformer": "OrdinalEncoder", "transformer_columns": ["state"]},
          	{"transformer": "MinMaxScaler", "transformer_columns": [
                            "some_float", "some_int"]},
        ]
        return config 
