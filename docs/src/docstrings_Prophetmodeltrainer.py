...
class ProphetModelTrainer(BaseModelTrainer):
    """
    This class implements a Prophet model trainer which uses Prophet module for performing time series predictions.
    """
    ...
    def __init__(self, problem_type=None, params={}, *args, **kwargs):
        """
        Initializes the ProphetModelTrainer object.

        Args:
        problem_type: Problem type for which the model will be trained.
        params: hyperparameters required for training Prophet model
        """
