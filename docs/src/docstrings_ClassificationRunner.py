...
class ClassificationRunner(BaseRunner):
    """
    A class that handles the process of classification tasks including data processing, model training, model deployment, prediction, and evaluation.

    Args:
        problem_type (str): Default is "classification". Indicates the problem type of the task.
        *args (Any): None
        **kwargs (Any): None
    """
    ...
    def __init__(self, problem_type="classification", *args, **kwargs):
        """
        Initializes an instance of ClassificationRunner.
    ...
    def train_model(self, data, dataset_version=None):
        ...
        Args:
            data (pd.DataFrame): DataFrame version of the processed data.
            dataset_version (str): Default is None. The version of the dataset.
    ...
    def evaluate_ground_truth(self, prediction_job=None): 
        ...
        Args:
            prediction_job (str): Default is None. The version of the prediction job.
        """
