...
class OfflineTrain(BaseTrain): 
    """
    This class provides methods to train a machine learning model offline with information 
    from both training data and metadata for the purpose of model development and testing. 
    """
    __REQUIRED_CONF__ = {
        "components": ["data_splitter", "metadata_tracker", "model_checker", "model_explainer", 
                        "model_visualizer", "model_bias_checker"], 
        "config": []
    }
    ...
    def split_data(self, data, **kwargs): 
        ...
        in the class. Return a dictionary with keys "train_data", "val_data" and "test_data", where 
        each value is a DataFrame containing the corresponding split.
        
        Args:
            data: A DataFrame containing the input data to be split.
            **kwargs: Optional keyword arguments to pass to the data splitter.

        Returns:
            A dictionary with keys "train_data", "val_data" and "test_data", where each value is a 
    ...
    def train_model(self, data, *args, **kwargs): 
        ...
        Args:
            data: A dictionary containing three data splits "train_data", "val_data" and "test_data", as 
    ...
    def check_model(self, data_dict, model, model_version, **kwargs):
        ...
        Args:
            data_dict: A dictionary containing three data splits "train_data", "val_data" and "test_data", as 
                       returned by the split_data method.
            model: The trained machine learning model to be checked.
            model_version: The version of the model being checked.
    ...
    def analyze_model(self, data_dict, model, model_version, **kwargs): 
        ...
        Args:
            data_dict: A dictionary containing three data splits "train_data", "val_data" and "test_data", as 
                       returned by the split_data method.
            model: The trained machine learning model to be analyzed.
            model_version: The version of the model to be analyzed.
    ...
    def compare_models(self, data_dict, model, model_version): 
        ...
        Args:
            data_dict: A dictionary containing three data splits "train_data", "val_data" and "test_data", as 
                       returned by the split_data method.
            model: The trained machine learning model to be analyzed.
            model_version: The version of the model being tested for improvement.
    ...
    def check_model_bias(self, data_dict, model, model_version):
        ...
        Args:
            data_dict: A dictionary containing three data splits "train_data", "val_data" and "test_data", as 
                       returned by the split_data method.
            model: The trained machine learning model to be checked for bias.
            model_version: The version of the model to be checked for bias.
        """
    ...
    def retrain_model_on_all_data(self, data, model_version, ref_model = None):
        ...
        Args:
            data: A DataFrame containing all the data to be used for retraining.
            model_version: The version of the model to be retrained.
            ref_model: The previous model to be used as reference.
