from component.hyperparameter_tuner.abstract_hyperparameter_tuner import AbstractHyperparameterTuner
...
class OptunaHyperparameterTuner(AbstractHyperparameterTuner): 
    ...
    def run_experiment(self, data, model_version, n_trials=100, timeout=600, *args, **kwargs): 
        ...
        for k,v in data.items(): 
            ...
            self.metadata_tracker.register_vc_resource(model_version, vc_info, key="%s-csv" %k, file_type="csv")
        ...
        self.metadata_tracker.log_metadata(model_version, id="winning_experiment_model_trainer", data={"winning_exp_model_trainer" : winning_exp_model_trainer})
